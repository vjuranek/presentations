...
\begin{frame}
    \frametitle{Summary}
    \begin{itemize}
     \item For locking the data on a shared storage lock located with data can be better solution then dedicated lock manager.
     ...
     \item Implementation of this approach can be found e.g. in sanlock project.
    \end{itemize}
\end{frame}

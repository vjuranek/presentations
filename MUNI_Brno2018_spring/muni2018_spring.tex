...
\begin{frame}
	\frametitle{Distributed databases}
	You probably don't want to implement it yourselves, just once example (broken read after write/read your writes consistency):
	\begin{figure}
		\centering
...
\begin{frame}
	\centering
	\huge{\textbf{What is an in-memory data grid?}}
\end{frame}

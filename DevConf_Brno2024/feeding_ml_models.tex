...
\begin{frame}
    ...
    Source code: \\
    \color{blue}{\href{https://github.com/vjuranek/debezium-mnist-demo}{https://github.com/vjuranek/debezium-mnist-demo}}\color{black}
    
    \vspace*{0.2cm}
    
    See also blog post:\\
    \color{blue}{\href{https://debezium.io/blog/2023/05/02/tensorflow-mnist-classification}{Image classification with Debezium and TensorFlow blog post}}\\
